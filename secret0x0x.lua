...
local Themes = {
	Names = {
		...
		VYXON = {
		Name = "Dark Red",
		Accent = Color3.fromRGB(255, 50, 50), -- Bright red for contrast
		AcrylicMain = Color3.fromRGB(5, 0, 0), -- Dark background with a hint of red
		AcrylicBorder = Color3.fromRGB(20, 5, 5), -- Slight red tint to the border
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 0, 0), Color3.fromRGB(30, 5, 5)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(45, 5, 5),
		Tab = Color3.fromRGB(50, 10, 10), -- Dark red for tabs
		Element = Color3.fromRGB(20, 0, 0), -- Almost black, but with a deep red hint
		ElementBorder = Color3.fromRGB(15, 0, 0),
		InElementBorder = Color3.fromRGB(50, 10, 10),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(50, 10, 10),
		ToggleToggled = Color3.fromRGB(255, 70, 70), -- A slightly brighter red
		SliderRail = Color3.fromRGB(50, 10, 10),
		DropdownFrame = Color3.fromRGB(25, 0, 0),
		DropdownHolder = Color3.fromRGB(10, 0, 0),
		DropdownBorder = Color3.fromRGB(15, 0, 0),
		DropdownOption = Color3.fromRGB(50, 10, 10),
		Keybind = Color3.fromRGB(50, 10, 10),
		Input = Color3.fromRGB(50, 10, 10),
		InputFocused = Color3.fromRGB(15, 0, 0),
		InputIndicator = Color3.fromRGB(90, 20, 20),
		InputIndicatorFocus = Color3.fromRGB(255, 70, 70),
		Dialog = Color3.fromRGB(10, 0, 0),
		DialogHolder = Color3.fromRGB(20, 5, 5),
		DialogHolderLine = Color3.fromRGB(35, 10, 10),
		DialogButton = Color3.fromRGB(25, 5, 5),
		DialogButtonBorder = Color3.fromRGB(45, 10, 10),
		DialogBorder = Color3.fromRGB(40, 10, 10),
		DialogInput = Color3.fromRGB(25, 5, 5),
		DialogInputLine = Color3.fromRGB(90, 20, 20),
		Text = Color3.fromRGB(255, 70, 70), -- Brighter red for visibility
