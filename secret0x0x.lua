...
local Themes = {
	...
	VYXON = {
		...
		AcrylicMain = Color3.fromRGB(10, 0, 0),
		AcrylicBorder = Color3.fromRGB(30, 0, 0),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 0, 0), Color3.fromRGB(30, 0, 0)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(50, 0, 0),
		Tab = Color3.fromRGB(60, 0, 0),
		Element = Color3.fromRGB(25, 0, 0),
		ElementBorder = Color3.fromRGB(10, 0, 0),
		InElementBorder = Color3.fromRGB(60, 0, 0),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(60, 0, 0),
		ToggleToggled = Color3.fromRGB(255, 50, 50),
		SliderRail = Color3.fromRGB(60, 0, 0),
		DropdownFrame = Color3.fromRGB(30, 0, 0),
		DropdownHolder = Color3.fromRGB(10, 0, 0),
		DropdownBorder = Color3.fromRGB(10, 0, 0),
		DropdownOption = Color3.fromRGB(60, 0, 0),
		Keybind = Color3.fromRGB(60, 0, 0),
		Input = Color3.fromRGB(60, 0, 0),
		InputFocused = Color3.fromRGB(10, 0, 0),
		InputIndicator = Color3.fromRGB(90, 0, 0),
		InputIndicatorFocus = Color3.fromRGB(255, 50, 50),
		Dialog = Color3.fromRGB(10, 0, 0),
		DialogHolder = Color3.fromRGB(20, 0, 0),
		DialogHolderLine = Color3.fromRGB(40, 0, 0),
		DialogButton = Color3.fromRGB(25, 0, 0),
		DialogButtonBorder = Color3.fromRGB(50, 0, 0),
		DialogBorder = Color3.fromRGB(45, 0, 0),
		DialogInput = Color3.fromRGB(25, 0, 0),
		DialogInputLine = Color3.fromRGB(90, 0, 0),
